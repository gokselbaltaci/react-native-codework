  ...
  return (
    <View style={styles.container}>
      <View style={styles.header_container}>
        ...
        <Text>
          <Text style={styles.job_location_title}>Locations:</Text>{' '}
          <Text style={styles.job_location}>{data.locations[0].name}</Text>
        </Text>
        <Text>
          <Text style={styles.job_level_title}>Job Level:</Text>{' '}
          <Text style={styles.job_level}>{data.levels[0].name}</Text>
        </Text>
      </View>
      ...
      <View style={styles.button_group}>
        ...
        <TouchableOpacity
          ...
          {item.includes(data.id) ? (
            <>
              <Icon name="ios-trash" size={20} color="#303f9f" />
            </>
          ) : (
            <>
